...
fotoplay = "https://telegra.ph/file/03b6a5f345ef6c1c9e6fb.jpg"
ngantri = "https://telegra.ph/file/03b6a5f345ef6c1c9e6fb.jpg"
from DroxMusic import call_py, DroxMusic, client as Client
owner = "1214622341"
from DroxMusic.helpers.yt_dlp import bash
from DroxMusic.helpers.chattitle import CHAT_TITLE
from DroxMusic.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from DroxMusic.helpers.thumbnail import gen_thumb
...
@DroxMusic.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
...
#play
@DroxMusic.on(events.NewMessage(pattern="^[?!/]تشغيل"))
...
#end
@DroxMusic.on(events.NewMessage(pattern="^[/?!]انهاء"))
@is_admin
...
@DroxMusic.on(events.NewMessage(pattern="^[?!/]فيديو"))
...
#playlist
@DroxMusic.on(events.NewMessage(pattern="^[?!/]التشغيل"))
@is_admin
...
#كود المغادرة
@DroxMusic.on(events.NewMessage(pattern="^[?!/]مغادرة"))
@is_admin
...
@DroxMusic.on(events.NewMessage(pattern="^[?!/]تخطي"))
@is_admin
...
@DroxMusic.on(events.NewMessage(pattern="^[?!/]ايقاف"))
@is_admin
...
@DroxMusic.on(events.NewMessage(pattern="^[?!/]استئناف"))
@is_admin
